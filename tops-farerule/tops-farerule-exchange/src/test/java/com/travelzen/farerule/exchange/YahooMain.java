...
public class YahooMain {
	...
	public static void main(String[] args) {
		String consumer_key = "dj0yJmk9VE9vWE9DTGRERGFrJmQ9WVdrOU0yazFiV1JwTnpRbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmeD1mNg";
		String consumer_secret = "94ba8dad05722da3d72eca8ff9ee73e3b866af89";
		String base_url = "https://query.yahooapis.com/v1/public/yql?";
		String yql_query = "select * from yahoo.finance.xchange where pair in (\"EURUSD\",\"GBPUSD\")";
		String yql_url = URLEncoder.encode(yql_query);
//		System.out.println(yql_url);
		String yql_opt = "&format=json";
		
		String request = base_url + yql_url + yql_opt;
