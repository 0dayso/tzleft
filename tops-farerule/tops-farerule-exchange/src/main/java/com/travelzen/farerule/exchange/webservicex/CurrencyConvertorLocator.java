...
public class CurrencyConvertorLocator extends org.apache.axis.client.Service implements CurrencyConvertor {
    ...
    public CurrencyConvertorSoap getCurrencyConvertorSoap() throws javax.xml.rpc.ServiceException {
    ...
    public CurrencyConvertorSoap getCurrencyConvertorSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            CurrencyConvertorSoapStub _stub = new CurrencyConvertorSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (CurrencyConvertorSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                CurrencyConvertorSoapStub _stub = new CurrencyConvertorSoapStub(new java.net.URL(CurrencyConvertorSoap_address), this);
                _stub.setPortName(getCurrencyConvertorSoapWSDDServiceName());
                return _stub;
            }
        }
