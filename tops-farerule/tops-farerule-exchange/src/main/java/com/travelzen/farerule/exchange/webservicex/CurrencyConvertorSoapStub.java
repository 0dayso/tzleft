...
package com.travelzen.farerule.exchange.webservicex;

public class CurrencyConvertorSoapStub extends org.apache.axis.client.Stub implements CurrencyConvertorSoap {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.webserviceX.NET/", "FromCurrency"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.webserviceX.NET/", "Currency"), Currency.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://www.webserviceX.NET/", "ToCurrency"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.webserviceX.NET/", "Currency"), Currency.class, false, false);
        oper.addParameter(param);
    ...
    public double conversionRate(Currency fromCurrency, Currency toCurrency) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
